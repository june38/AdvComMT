	...
	public DisplayMap() {
		...
		okAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				m.put(Integer.parseInt(idFill.getText()), nameFill.getText());
				table.repaint();
				idFill.setText("");
				nameFill.setText("");
				addWindow.setVisible(false);
		...
		searchField.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!isString){
				String s = m.get(Integer.parseInt(searchField.getText()));
					if(s != null){
						JOptionPane.showMessageDialog(null,"The student name is "+s);
					}else{
